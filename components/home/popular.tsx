...
const Popular=()=>{
  ...
  return(
      <section id='hero' className="  bg-[#F3F4F6] w-full h-full text-black mobile:hidden flex flex-col md:flex">
            
            <div className="md:mx-auto md:container space-x-5 flex justify-between ">
               <div className="relative w-full hidden md:block py-16">
                <h1 className="text-2xl font-bold  text-center justify-center">Popular Categories</h1>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 flex-wrap p-10">
